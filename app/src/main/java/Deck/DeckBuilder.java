...
public class DeckBuilder {
    ...
    public DeckBuilder(){
        ...
        decksPadrao.add(Cor.txtAmarelo("JOHN WICK: MUITO DANO DIRETO EM UMA CHUVA DE BALAS!"));
        decksPadrao.add(Cor.txtVerde("BALANCEADO: NEM UM NEM OUTRO, PROVAVELMENTE NAO TA MUITO BALANCEADO TAMBEM!"));
    ...
    public void rodar(Heroi heroi){
        Textos.limpaTela();
        int escolha = InputHandler.selecionar(decksPadrao, Cor.txtCinza("Por enquanto nao tem montador de deck vai ter que se contentar com isso:"));

        switch (escolha){
            /*a ideia por tras desse deck aqui é q meio q vc tenta atingir um jackpot stackando mestre das laminas 
            e corte rapido, e usando cartas baratas -> usar a mao completa pra ganhar mais 2 de energia -> tentar repetir o ciclo -> turno infinito. */
            case 0 -> { 
