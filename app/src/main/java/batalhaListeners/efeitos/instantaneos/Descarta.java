...
/** Abre um menu com as cartas da mao e permite descartar uma quantidade ( a carta que chamou esse efeito nao pode ser descartada por ele )*/
public class Descarta extends Instantaneo {
    ...
    public void onCreate(Batalha batalha, Heroi heroi) {
        if (this.getAlvo() instanceof Heroi h) {
            ...
            List<Carta> cartasDescartaveis = new ArrayList<>(h.getMaoAtual().mostrar());
            if (cartaEmUso != null) {
