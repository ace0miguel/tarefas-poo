...
public class CartaPoderTest {
    ...
    public void criarECopiarCartaPoder() {
        PoderTeste poder = new PoderTeste("For̤a", "Aumenta atributos");
    ...
    public void usarCartaComEnergiaESacrificio() {
        ...
        CartaPoder carta = new CartaPoder("For̤a Oculta", "...", 2, poder);
    ...
    public void formatacaoDaDescricao() {
        ...
        assertTrue(desc.contains("Sacrif") && desc.contains("2"));
